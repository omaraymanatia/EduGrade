...
export default function Sidebar({ className }: SidebarProps) {
  ...
  return (
    <aside className={cn("w-64 bg-white shadow-md h-screen flex flex-col", className)}>
      <div className="p-6 border-b border-gray-200">
        <h2 className="text-xl font-bold text-primary-600">AI Grader</h2>
        <p className="text-sm text-gray-600">{role === "professor" ? "Professor" : "Student"} Dashboard</p>
      </div>
