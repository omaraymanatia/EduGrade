import { users, exams, questions, options, studentExams, studentAnswers } from "@shared/schema";
import type { 
  User, InsertUser, 
  Exam, InsertExam, 
  Question, InsertQuestion,
  Option, InsertOption,
  StudentExam, InsertStudentExam,
...
export interface IStorage {
  ...
  updateStudentExam(id: number, data: Partial<StudentExam>): Promise<StudentExam | undefined>;
  
  // Student answer methods
  createStudentAnswer(studentAnswer: InsertStudentAnswer): Promise<StudentAnswer>;
  getStudentAnswersByStudentExam(studentExamId: number): Promise<StudentAnswer[]>;
...
export class MemStorage implements IStorage {
  ...
  // Student exam methods
  async createStudentExam(insertStudentExam: InsertStudentExam): Promise<StudentExam> {
  ...
  async updateStudentExam(id: number, data: Partial<StudentExam>): Promise<StudentExam | undefined> {
  ...
  // Student answer methods
  async createStudentAnswer(insertStudentAnswer: InsertStudentAnswer): Promise<StudentAnswer> {
  ...
  async getStudentAnswersByStudentExam(studentExamId: number): Promise<StudentAnswer[]> {
    return Array.from(this.studentAnswers.values())
      .filter((sa) => sa.studentExamId === studentExamId);
  }
}
